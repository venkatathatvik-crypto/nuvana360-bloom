...
export function ClassroomOSSection() {
    ...
    return (
        <section id="classroom-os" className="min-h-0 md:min-h-screen flex items-center py-2 md:py-24 bg-gradient-to-b from-background to-blue-950/10 relative overflow-hidden snap-start">
            {/* Blenders */}
