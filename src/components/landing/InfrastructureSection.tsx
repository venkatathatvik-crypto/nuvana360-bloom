...
export function InfrastructureSection() {
    return (
        <section id="infrastructure" className="min-h-0 md:min-h-screen flex items-start md:items-center py-2 md:py-24 relative overflow-hidden bg-slate-950 snap-start">
            {/* Background Grid */}
