...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="min-h-0 md:min-h-screen max-h-screen md:max-h-none flex items-start md:items-center relative pt-2 pb-0 md:py-24 bg-[#020617] snap-start -mt-8 md:mt-0">
