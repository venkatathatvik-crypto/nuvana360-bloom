      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-2xl mx-auto">
            Launch Nuvana360 today and join thousands of educators and students already experiencing the future of education.
          </p>
          ...
          {/* Trust indicators */}
          <div className={`mt-12 flex flex-wrap justify-center gap-8 text-muted-foreground transition-all duration-1000 delay-500 ${
